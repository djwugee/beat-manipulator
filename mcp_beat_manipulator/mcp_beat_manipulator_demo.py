#!/usr/bin/env python3
"""
Demo MCP (Model Context Protocol) Server for Beat Manipulator
This is a simplified demo version that shows the MCP server functionality
without requiring the full beat-manipulator dependencies.
"""
